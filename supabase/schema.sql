...
INSERT INTO page_content (page, section, locale, is_active, extra) VALUES
('home', 'faq', 'es', true, '{"badge":"FAQ","title":"Preguntas Frecuentes","subtitle":"Respuestas a las preguntas más comunes sobre nuestros servicios.","items":[{"question":"¿Qué diferencia a Blackshield de un despacho de abogados tradicional en México?","answer":"A diferencia de un despacho convencional que se limita a la gestión de trámites o litigios, Blackshield integra inteligencia estratégica y análisis de contexto (político, social, reputacional y de seguridad) antes de actuar. No solo aplicamos la ley; controlamos el entorno para que la solución legal sea viable y sostenible."},{"question":"Si ya tengo asesores legales en mi país de origen, ¿cómo se integra Blackshield?","answer":"Actuamos como su brazo ejecutor y aliado estratégico local. No desplazamos a sus asesores de confianza; al contrario, colaboramos con ellos aportando el aterrizaje real en territorio mexicano, traduciendo la estrategia global en ejecución local precisa."},{"question":"¿Pueden representarme en México sin que yo tenga que viajar al país?","answer":"Sí. Esa es una de nuestras capacidades centrales. Actuamos como su punto de control y representación estratégica, permitiéndole operar, invertir o resolver conflictos en México con total visibilidad y control desde cualquier parte del mundo."},{"question":"¿A qué se refieren con Ciclo de Inteligencia aplicado a lo legal?","answer":"Significa que no actuamos bajo suposiciones. El proceso incluye: identificación de necesidades, captación de información real del terreno, validación, análisis de escenarios (qué puede salir mal y qué se puede aprovechar) y, finalmente, la toma de decisiones basada en datos, no en improvisación."},{"question":"¿En qué sectores o industrias tienen experiencia de intervención?","answer":"Intervenimos en cualquier sector donde exista un interés estratégico: desde proyectos industriales, cadenas comerciales, infraestructura y energía, hasta la protección de activos inmobiliarios, propiedad intelectual y asuntos de derecho corporativo o penal complejo."},{"question":"¿Cómo ayudan a una empresa que quiere entrar al mercado mexicano por primera vez?","answer":"Desde la base: realizamos el análisis de viabilidad y contexto, definimos la mejor estructura legal y fiscal (considerando tratados internacionales), seleccionamos ubicaciones seguras y coordinamos la relación con actores clave para asegurar una entrada ordenada y sin riesgos ocultos."},{"question":"¿Qué tipo de apoyo ofrecen en situaciones de crisis o delitos en México?","answer":"Ofrecemos representación activa de víctimas y gestión de crisis. Esto incluye desde el seguimiento de investigaciones ante autoridades y atención consular, hasta el control de daños reputacionales y mediáticos, asegurando que el caso no pierda dirección ni se estanque."},{"question":"¿Cómo garantizan la discreción y seguridad de la información?","answer":"La discreción es uno de nuestros pilares operativos. Manejamos protocolos estrictos de confidencialidad y visibilidad selectiva, entendiendo que muchos de nuestros clientes operan en entornos de alta sensibilidad donde el bajo perfil es una ventaja estratégica."},{"question":"¿Qué aspectos cubren en sus servicios de estructuración fiscal y corporativa?","answer":"Diseñamos estructuras que cumplen con estándares internacionales (PLD, Due Diligence, Beneficiario Controlador). El objetivo es evitar que una mala planeación o una relación comercial no verificada se convierta en una contingencia legal o una sanción internacional."},{"question":"¿Cuál es el primer paso para trabajar con Blackshield?","answer":"El proceso inicia con una consulta inicial confidencial. En esta etapa escuchamos el caso o proyecto, realizamos un diagnóstico preliminar y definimos si el asunto requiere una intervención específica o una estrategia integral de largo plazo."}]}')
ON CONFLICT (page, section, locale) DO UPDATE SET extra = EXCLUDED.extra;
...
INSERT INTO page_content (page, section, locale, is_active, extra) VALUES
('home', 'faq', 'en', true, '{"badge":"FAQ","title":"Frequently Asked Questions","subtitle":"Answers to the most common questions about our services.","items":[{"question":"What sets Blackshield apart from a traditional law firm in Mexico?","answer":"Unlike a conventional firm limited to filings or litigation, Blackshield integrates strategic intelligence and context analysis (political, social, reputational and security) before acting. We don''t just apply the law; we control the environment so the legal solution is viable and sustainable."},{"question":"If I already have legal advisors in my home country, how does Blackshield integrate?","answer":"We act as your local executor and strategic ally. We don''t displace your trusted advisors; on the contrary, we collaborate with them by providing the real landing in Mexican territory, translating the global strategy into precise local execution."},{"question":"Can you represent me in Mexico without me having to travel to the country?","answer":"Yes. That is one of our core capabilities. We act as your control point and strategic representation, allowing you to operate, invest or resolve conflicts in Mexico with full visibility and control from anywhere in the world."},{"question":"What do you mean by Intelligence Cycle applied to legal matters?","answer":"It means we don''t act on assumptions. The process includes: needs identification, gathering real field information, validation, scenario analysis (what can go wrong and what can be leveraged) and, finally, data-driven decision-making, not improvisation."},{"question":"In which sectors or industries do you have intervention experience?","answer":"We intervene in any sector where strategic interests exist: from industrial projects, commercial chains, infrastructure and energy, to the protection of real estate assets, intellectual property and complex corporate or criminal law matters."},{"question":"How do you help a company entering the Mexican market for the first time?","answer":"From the ground up: we conduct viability and context analysis, define the best legal and tax structure (considering international treaties), select safe locations and coordinate relationships with key stakeholders to ensure an orderly entry without hidden risks."},{"question":"What type of support do you offer in crisis situations or crimes in Mexico?","answer":"We offer active victim representation and crisis management. This includes everything from monitoring investigations before authorities and consular assistance, to controlling reputational and media damage, ensuring the case does not lose direction or stall."},{"question":"How do you guarantee the discretion and security of information?","answer":"Discretion is one of our operational pillars. We manage strict confidentiality protocols and selective visibility, understanding that many of our clients operate in high-sensitivity environments where a low profile is a strategic advantage."},{"question":"What aspects do your tax and corporate structuring services cover?","answer":"We design structures that comply with international standards (AML, Due Diligence, Beneficial Owner). The goal is to prevent poor planning or an unverified business relationship from becoming a legal contingency or international sanction."},{"question":"What is the first step to working with Blackshield?","answer":"The process begins with a confidential initial consultation. At this stage we listen to the case or project, perform a preliminary diagnosis and determine whether the matter requires a specific intervention or a comprehensive long-term strategy."}]}')
ON CONFLICT (page, section, locale) DO UPDATE SET extra = EXCLUDED.extra;
